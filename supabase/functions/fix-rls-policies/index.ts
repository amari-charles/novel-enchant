...
serve(async (req) => {
  ...
  try {
    ...
    try {
      // Update all RLS policies to allow service role
      const policies = [
        // enhancement_runs policies
        ...
        // scene_images policies
        `DROP POLICY IF EXISTS "Users can view images of own scenes" ON scene_images`,
        ...
        `DROP POLICY IF EXISTS "Users can insert images to own scenes" ON scene_images`,
        ...
        `DROP POLICY IF EXISTS "Users can update images of own scenes" ON scene_images`,
        ...
        // scenes_current_image policies
        `DROP POLICY IF EXISTS "Users can view current images of own scenes" ON scenes_current_image`,
        ...
        `DROP POLICY IF EXISTS "Users can insert current images for own scenes" ON scenes_current_image`,
        ...
        `DROP POLICY IF EXISTS "Users can update current images of own scenes" ON scenes_current_image`,
    ...
    return new Response(
      JSON.stringify({ error: error.message || 'Failed to fix policies' }),
